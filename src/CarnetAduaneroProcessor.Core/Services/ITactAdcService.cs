...
{
    /// <summary>
    /// Interfaz para el servicio de procesamiento de documentos TACT/ADC
    /// </summary>
    public interface ITactAdcService
    {
        /// <summary>
        /// Extrae datos de un archivo PNG de documento TACT/ADC
        /// </summary>
        /// <param name="filePath">Ruta del archivo PNG</param>
        /// <returns>Documento TACT/ADC procesado</returns>
        Task<TactAdc> ExtraerDatosAsync(string filePath);
        ...
        /// <returns>Documento TACT/ADC procesado</returns>
        Task<TactAdc> ExtraerDatosAsync(Stream fileStream, string fileName);
        ...
        /// <param name="fileName">Nombre del archivo</param>
        /// <returns>Documento TACT/ADC procesado</returns>
        Task<TactAdc> ExtraerDatosAsync(byte[] fileBytes, string fileName);
        ...
        /// <returns>Documento TACT/ADC procesado</returns>
        Task<TactAdc> ProcesarTextoOcrAsync(string textoOcr);
