...
namespace CarnetAduaneroProcessor.Infrastructure.Services
{
    ...
    public class OllamaAiPostProcessorService : IAiPostProcessorService
    {
        ...
        private string DetectarTipoDocumento(string nombreArchivo)
        {
            ...
            {
                // Para archivos con nombres ambiguos como "5.TATC.png", usar genérico
                // para que la IA pueda analizar el contenido real del documento
                if (nombreLower.StartsWith("5.") || nombreLower.StartsWith("tatc") || nombreLower.StartsWith("tact"))
                    return "Generico";
                else
                    return "TactAdc";
            }
...
3. Extrae la información en formato JSON estructurado con los nombres exactos de campos
4. Para fechas, usa el formato ISO 8601 (YYYY-MM-DD) para fechas simples o (YYYY-MM-DDTHH:mm:ss) para fechas con hora
5. Para números, usa el formato numérico (NO strings): Peso, Volumen, CantidadBultos, ValorMercancia deben ser números
6. IMPORTANTE: ConfianzaExtraccion debe ser un número decimal entre 0.0 y 1.0 (ej: 0.95)

CAMPOS ESPECÍFICOS DE TACT/ADC (usa estos nombres exactos):
...
- ConfianzaExtraccion: Nivel de confianza en la extracción (0.0 a 1.0) - DEBE SER NÚMERO
...
IMPORTANTE: 
- Los campos numéricos (Peso, Volumen, CantidadBultos, ValorMercancia, ConfianzaExtraccion) DEBEN SER NÚMEROS, NO strings
- Usa los nombres exactos de campos en PascalCase como se muestran arriba
- Si un campo no se puede extraer, déjalo como null
- Extrae TODA la información visible en la imagen
...
EJEMPLO DE RESPUESTA ESPERADA:
{
  ...
  ""Origen"": ""SHANGHAI"",
  ""Destino"": ""SAN ANTONIO"",
  ""Consignatario"": ""IMPORTADORA ABC"",
  ""Consignante"": ""EXPORTADORA XYZ"",
  ""DescripcionMercancia"": ""ELECTRONICOS"",
  ""Peso"": 1500.5,
  ""Volumen"": 25.8,
  ""CantidadBultos"": 50,
  ""TipoBulto"": ""CAJAS"",
