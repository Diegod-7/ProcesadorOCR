...
13. CRÍTICO: Incluye el campo TextoExtraido con TODO el texto visible en la imagen
...
- CARNÉ ADUANERO: 
  ...
  * TextoExtraido: TODO el texto visible en la imagen (nombres, números, fechas, códigos, etc.)
...
- Para TextoExtraido, incluye TODO el texto visible en la imagen
...
- TextoExtraido (NO textoExtraido)
- ConfianzaExtraccion (NO confianzaExtraccion)";
        ...
        private string CrearJsonVacio()
        {
            var jsonVacio = new
            {
                ...
                EsValido = false,
                MensajeError = "No se pudo extraer información de la imagen",
                NombreArchivo = "",
                HashArchivo = "",
                MetodoExtraccion = "IA Multimodal (Gemma 3: 4B)",
