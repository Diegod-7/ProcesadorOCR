...
namespace CarnetAduaneroProcessor.Infrastructure.Services
{
    ...
    public class OllamaAiPostProcessorService : IAiPostProcessorService
    {
        ...
        private string DetectarTipoDocumento(string nombreArchivo)
        {
            ...
            // Priorizar la detección por contenido del documento
            // Si el nombre del archivo es ambiguo (como "5.TATC.png"), usar el tipo genérico
            // para que la IA pueda analizar el contenido y determinar el tipo real
...
6. IMPORTANTE: ConfianzaExtraccion debe ser un número decimal entre 0.0 y 1.0 (ej: 0.95)
7. ATENCIÓN ESPECIAL: Si encuentras un documento TACT/ADC que contenga información adicional (como número de DR), extrae TODA la información disponible mapeándola a los campos del modelo TactAdc
...
- **TACT/ADC**: Busca campos como TATC, Compañía, Origen, Destino, etc. 
  *NOTA: Los TACT/ADC pueden contener información adicional como número de DR, pero se mapean a los campos del modelo TactAdc*
...
CAMPOS ESPECÍFICOS PARA TACT/ADC (usa estos nombres exactos del modelo):
...
- Usa EXACTAMENTE los nombres de campos mostrados arriba para TACT/ADC
- Si un campo no se puede extraer, déjalo como null
- Extrae TODA la información visible en la imagen
- NO inventes información que no esté en el documento

EJEMPLO DE RESPUESTA ESPERADA PARA TACT/ADC:
{
  ""NumeroTatc"": ""2025391250035445"",
  ""NumeroContenedor"": ""CMAU 650120-0"",
  ""NumeroSellos"": ""M0442444"",
  ""EmpresaEmisora"": ""MEDLOG CHILE EXTRAPORTUARIOS LIMITADA"",
  ""DireccionEmpresa"": ""CAMINO LAS MERCEDES 14851 - SANTIAGO"",
  ""RutEmisor"": ""12452809-7"",
  ""FechaEmision"": ""2025-06-25"",
  ""TipoDocumento"": ""CONTENEDOR IMPORTACION - POR MANIFIESTO - INDIRECTO"",
  ""BlArmador"": ""(M)BAC0549074 / (H)DACA78565"",
  ""Consignatario"": ""FORUS S A"",
  ""RutConsignatario"": ""86963200-7"",
  ""DireccionConsignatario"": ""AV LAS CONDES NRO 11281, BLOCK C - SANTIAGO"",
  ""LineaOperadora"": ""CMA-CGM CHILE S A"",
