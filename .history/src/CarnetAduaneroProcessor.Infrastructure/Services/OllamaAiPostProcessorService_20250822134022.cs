...
- PuertoDesembarque: Puerto de desembarque (ej: SAN ANTONIO)
- PuertoDestino: Puerto de destino (ej: SAN ANTONIO)
- BuqueViaje: Buque/Viaje (ej: CMA CGM BEIRA / OLISSN1)
- Patio: Patio (ej: PATIO ZONA PRIMARIA)
...
EJEMPLO DE RESPUESTA ESPERADA:
{
  ...
  ""BuqueViaje"": ""CMA CGM BEIRA / OLISSN1"",
  ""Patio"": ""PATIO ZONA PRIMARIA"",
