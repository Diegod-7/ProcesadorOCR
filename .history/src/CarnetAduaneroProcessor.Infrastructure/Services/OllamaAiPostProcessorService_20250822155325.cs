...
namespace CarnetAduaneroProcessor.Infrastructure.Services
{
    ...
    public class OllamaAiPostProcessorService : IAiPostProcessorService
    {
        ...
        {
            _logger.LogInformation("Seleccionando prompt para tipo de documento: {Tipo}", tipoDocumento);
            
            switch (tipoDocumento)
            {
                case "ComprobanteTransaccion":
                    _logger.LogInformation("Usando prompt de ComprobanteTransaccion");
                    return CrearPromptComprobanteTransaccion();
                case "CarnetAduanero":
                    _logger.LogInformation("Usando prompt de CarnetAduanero");
                    return CrearPromptCarnetAduanero();
                case "DocumentoRecepcion":
                    _logger.LogInformation("Usando prompt de DocumentoRecepcion");
                    return CrearPromptDocumentoRecepcion();
                case "DeclaracionIngreso":
                    _logger.LogInformation("Usando prompt de DeclaracionIngreso");
                    return CrearPromptDeclaracionIngreso();
                case "GuiaDespacho":
                    _logger.LogInformation("Usando prompt de GuiaDespacho");
                    return CrearPromptGuiaDespacho();
                case "TactAdc":
                    _logger.LogInformation("Usando prompt de TactAdc");
                    return CrearPromptTactAdc();
                case "SeleccionAforo":
                    _logger.LogInformation("Usando prompt de SeleccionAforo");
                    return CrearPromptSeleccionAforo();
                default:
                    _logger.LogInformation("Usando prompt genérico para tipo: {Tipo}", tipoDocumento);
