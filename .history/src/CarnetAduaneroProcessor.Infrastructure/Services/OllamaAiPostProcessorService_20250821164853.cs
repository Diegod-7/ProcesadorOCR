...
{
    /// <summary>
    /// Servicio de post-procesamiento con IA usando Ollama con DeepSeek R1: 8B
    /// </summary>
    public class OllamaAiPostProcessorService : IAiPostProcessorService
    {
        ...
        public OllamaAiPostProcessorService(ILogger<OllamaAiPostProcessorService> logger, IConfiguration configuration, HttpClient httpClient)
        {
            ...
            // Modelo de Ollama (por defecto DeepSeek R1: 8B)
            _modeloOllama = _configuration["Ollama:Model"] ?? "deepseek-r1:8b";
        }
        ...
        /// <summary>
        /// Crea un prompt mejorado para Ollama con DeepSeek R1: 8B
        /// </summary>
