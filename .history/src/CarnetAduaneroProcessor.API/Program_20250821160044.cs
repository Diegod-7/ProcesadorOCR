...
builder.Services.AddControllers()
    ...
    builder.Services.AddScoped<IHybridOcrService, HybridOcrService>();

// Registrar servicios de IA
builder.Services.AddHttpClient();
builder.Services.AddScoped<IAiPostProcessorService, OpenAiPostProcessorService>();
// builder.Services.AddScoped<IAiPostProcessorService, OllamaPostProcessorService>(); // Alternativa gratuita
