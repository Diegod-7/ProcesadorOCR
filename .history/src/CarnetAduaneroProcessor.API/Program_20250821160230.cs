...
builder.Services.AddHttpClient<IAiPostProcessorService, OllamaAiPostProcessorService>();
builder.Services.AddScoped<IAiPostProcessorService, OllamaAiPostProcessorService>();
